...
const fn_log_qh_main_info = async (codes=[]) => {
    ...
    for (let code of codes) {
        ...
        let c_min_1_180  = data.latest >= data.min_1_180  ? "red" : "green";
        let c_min_5_120  = data.latest >= data.min_5_120  ? "red" : "green";
        let c_min_15_90  = data.latest >= data.min_15_90  ? "red" : "green";
        let c_min_60_60  = data.latest >= data.min_60_60  ? "red" : "green";
        let c_min_240_20 = data.latest >= data.min_240_20 ? "red" : "green";
        let c_min_day_10 = data.latest >= data.min_day_10 ? "red" : "green";
        let c_max_1_180  = data.latest >= data.max_1_180  ? "red" : "green";
        let c_max_5_120  = data.latest >= data.max_5_120  ? "red" : "green";
        let c_max_15_90  = data.latest >= data.max_15_90  ? "red" : "green";
        let c_max_60_60  = data.latest >= data.max_60_60  ? "red" : "green";
        let c_max_240_20 = data.latest >= data.max_240_20 ? "red" : "green";
