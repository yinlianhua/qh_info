...
const fn_log_qh_main_info = async (codes=[]) => {
    ...
    // TODO: 添加 MAX-MIN 比例
    logs.push("+----+--------+-------+----------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+----------+");
    logs.push(`|    |  Code  | Score |  Latest  |   05MIN_120(AVG, MIN, MAX)   |   05MIN_240(AVG, MIN, MAX)   |   15MIN_120(AVG, MIN, MAX)   |   15MIN_240(AVG, MIN, MAX)   |     4H_20(AVG, MIN, MAX)     |      Day_10(AVG, MIN, MAX)   |      Day_30(AVG, MIN, MAX)   |      Day_60(AVG, MIN, MAX)   |   Name   |`);
    logs.push("+----+--------+-------+----------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+----------+");
    ...
    for (let code of codes) {
        ...
        */
        ...
        let c_avg_05_120 = data.latest >= data.avg_05_120 ? "red" : "green";
        let c_avg_05_240 = data.latest >= data.avg_05_240 ? "red" : "green";
        ...
        let c_min_05_120 = data.latest <= data.min_05_120 ? "red" : "green";
        let c_min_05_240 = data.latest <= data.min_05_240 ? "red" : "green";
        ...
        let c_max_05_120 = data.latest >= data.max_05_120 ? "red" : "green";
        let c_max_05_240 = data.latest >= data.max_05_240 ? "red" : "green";
        ...
        logs.push(`| ${no.toString().padStart(2)} | ${f_code} |   ${f_score}  | ${f_latest} | ${f_avg_05_120}, ${f_min_05_120}, ${f_max_05_120} | ${f_avg_05_240}, ${f_min_05_240}, ${f_max_05_240} | ${f_avg_15_120}, ${f_min_15_120}, ${f_max_15_120} | ${f_avg_15_240}, ${f_min_15_240}, ${f_max_15_240} | ${f_avg_240_12}, ${f_min_240_12}, ${f_max_240_12} | ${f_avg_day_10}, ${f_min_day_10}, ${f_max_day_10} | ${f_avg_day_30}, ${f_min_day_30}, ${f_max_day_30} | ${f_avg_day_60}, ${f_min_day_60}, ${f_max_day_60} | ${f_name}`);
        logs.push("+----+--------+-------+----------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+------------------------------+----------+");
    }
